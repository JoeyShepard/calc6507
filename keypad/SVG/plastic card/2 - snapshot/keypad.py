...
#Some notes about slicer but doesn't matter here
FONT_SIZE=60
...
#f.write('>\n')
f.write(f'width="100%" height="{IMG_HEIGHT}">\n')

#Bounding box for card printing

f.write(f'<rect width="{EDGE_WIDTH}" height="{EDGE_HEIGHT}" stroke="yellow" stroke-width="3" fill="transparent" />\n\n')
f.write(f'<rect y="{EDGE_HEIGHT+EDGE_GAP}" width="{EDGE_WIDTH}" height="{EDGE_HEIGHT}" stroke="yellow" stroke-width="3" fill="transparent" />\n\n')
