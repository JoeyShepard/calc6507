...
;=============
	FUNC main, begin		;start in Setup and jump here
		...
		;Start here:
			;each of 3 sections in own file
			;will assembler throw error if they overlap?
			;JMP macro should be able to tell which bank it's in
				;maybe keep function names in string in assembler?
				;also, may be easy to do manually
